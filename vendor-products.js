...
productDiscoveryFields.innerHTML = '<label>Product category<input id="productCategory" required minlength="2" maxlength="80" placeholder="For example: Home & kitchen"/></label><label>Product type<input id="productType" required minlength="2" maxlength="80" placeholder="For example: Cookware"/></label>';
...
productKeywordsField.after(productSpecificationsField);
